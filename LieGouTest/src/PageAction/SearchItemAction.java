...
public class SearchItemAction {
	...
	public SearchItemAction(WebDriver driver){      
		this.driver = driver;   
		}      
	/**
	 * 搜索主项：
	 ...
	 * @throws Exception
	 */ 
	public static void SearchExpansion(WebDriver driver,int industrycuston1,int industrycuston2,int experience,int education,int salaryexpectation) throws Exception 
	{
	 ...
	 *
	 */
	public static void SearchExpansionforconst(WebDriver driver,int experience,int education,int salaryexpectation) throws Exception 
	{
		SearchItemElement.Openbutton(driver).click();
//		SearchItemElement.IndustryNolimit(driver).click();
//		SearchItemElement.experience(driver).get(experience).click();
//		SearchItemElement.Education(driver).get(education).click();
//		SearchItemElement.SalaryExpectation(driver).get(salaryexpectation).click();
	}
